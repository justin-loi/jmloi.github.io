...
While many believe that resurrecting extinct species would help correct some of the mistakes humans have made, it would not because of all the problems that will come with it. For instance, the vast amount of money and resources needed to repopulate the species is one of the many problems. Another issue is the effects these animals would bring into their new environments and the ecosystems are unpredictable. Finally, the exorbitant amount of money that we would be spending on their de-extinction, could be better used to sustain the endangered animals still alive and their habitats that are slowly becoming lost. 
Finally, the biggest concern of genetic manipulation is how it will affect the human species. The ability to edit genes for the human species is similar to opening Pandora’s Box, seemingly beneficial and tempting, but it  filled the world with problems that could not have been predicted. The tempting part of gene manipulation is the possibilities in the advancement of medicine. Instead of relying on methods that can have devastating side effects, like chemotherapy, why not edit the genes to stop the cancer from growing. Additionally why make an unborn child suffer with a disease when you can simply edit the gene out. Thus, the views of gene manipulation seem wonderful in that aspect. 
